    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .headers(headers -> headers
                        ...
                        /*
                         * API responses do not load resources, while the bundled Swagger UI needs its
                         * same-origin scripts, styles, images and OpenAPI request. Keep everything else
                         * denied and continue to forbid framing and base-URL rewriting.
                         */
